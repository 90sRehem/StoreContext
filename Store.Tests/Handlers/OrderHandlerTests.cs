...
namespace Store.Tests.Handlers
{
    ...
    public class OrderHandlerTests
    {
        ...
        [TestMethod]
        [TestCategory("Handlers")]
        public void Dado_um_promocode_inexistente_o_pedido_nao_deve_ser_gerado_normalmente()
        {
            // TO DO
            Assert.IsTrue(true);
        }
        ...
        [TestMethod]
        [TestCategory("Handlers")]
        public void Dado_um_pedido_pedido_sem_itens_o_mesmo_nao_deve_ser_gerado()
        {
            // TO DO
            Assert.IsTrue(true);
        }
